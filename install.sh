...
sudo apt update
sudo apt install rxvt-unicode openbox openbox-gnome-session openbox-menu obconf neovim feh xcompmgr tig tdc cbatticon spotify-client stalonetray global universal-ctags blueman scrot most graphicsmagick
